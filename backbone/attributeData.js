...
initialize: function(){
  //  alert("ValueData model generated");
    ...
    //var temp=property;
    var pmodel= new PropertyBO(property);

      pmodel.setIndexation("2222222");
      individualModel.setFirstName("joao");
...
PropertyBO = Backbone.Model.extend({
    ...
    setProductPaymentFrequency: function(value2){
        this.set({"ProductPaymentFrequency": value2});
    },
